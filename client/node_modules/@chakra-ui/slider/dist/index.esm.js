...
var RangeSlider = forwardRef(function RangeSlider2(props, ref) {
  ...
  const ctx = useMemo2(() => ({ ...context, name: sliderProps.name }), [context, sliderProps.name]);
...
var Slider = forwardRef2((props, ref) => {
  ...
  const styles = useMultiStyleConfig2("Slider", sliderProps);
  const ownProps = omitThemingProps2(sliderProps);
  ...
  return /* @__PURE__ */ React.createElement(SliderProvider, {
    ...
    __css: styles.container
  }, sliderProps.children, /* @__PURE__ */ React.createElement("input", {
    ...inputProps
  }))));
});
